...
=======
    ...
    <link rel="stylesheet" href="{{ url('css/owl.theme.default.min.css') }}">
    <link rel="stylesheet" href="{{ url('css/style.css') }}">
    <link rel="stylesheet" href="{{ url('css/konsultasi.css') }}">
...
<body>
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand font-jakarta nav-link" href="/ "><img src="{{ url('images/logo.png') }}"
                    alt="logo">Bayu Tirta</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="{{ url('/konsultasi') }}">Konsultasi</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-10">
                    ...
                    <div class="footer-desc">
                        <p class="font-jakartas">Bayu Tirta Cell adalah konter resmi di Malang yang melayani service
                            untuk segala
...
>>>>>>> 59ef2d77744f592732a90af1aeda2f8d7baa13fb
