            ...
            <div class="col-lg-9 col-md-8">
                    ...
                    <div class="card-body p-4">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                ...
                                <p class="text-muted mb-0">Mulai konsultasikan masalah perangkat Anda dengan tim teknisi ahli kami</p>
                            </div>
                ...
                <div id="formKonsultasi" class="card shadow-sm mb-4">
                    <div class="card-header bg-white">
                        <div class="d-flex align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-text text-primary me-2" viewBox="0 0 16 16">
                                <path d="M2.678 11.894a1 1 0 0 1 .287.801 10.97 10.97 0 0 1-.398 2c1.395-.323 2.247-.697 2.634-.893a1 1 0 0 1 .71-.074A8.06 8.06 0 0 0 8 14c3.996 0 7-2.807 7-6 0-3.192-3.004-6-7-6S1 4.808 1 8c0 1.468.617 2.83 1.678 3.894zm-.493 3.905a21.682 21.682 0 0 1-.713.129c-.2.032-.352-.176-.273-.362a9.68 9.68 0 0 0 .244-.637l.003-.01c.248-.72.45-1.548.524-2.319C.743 11.37 0 9.76 0 8c0-3.866 3.582-7 8-7s8 3.134 8 7-3.582 7-8 7a9.06 9.06 0 0 1-2.347-.306c-.52.263-1.639.742-3.468 1.105z"/>
                                <path d="M4 5.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zM4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8zm0 2.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5z"/>
                            </svg>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('konsultasi.submit') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">Pilih kategori yang paling sesuai dengan masalah perangkat Anda</div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="perangkat" name="perangkat" placeholder="Masukkan jenis perangkat (contoh: Xiaomi Redmi Note 10)" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" id="masalah" name="masalah" rows="5" placeholder="Deskripsikan masalah perangkat Anda secara detail" required></textarea>
                                </div>
                                <div class="form-text">Jelaskan gejala yang muncul, kapan masalah mulai terjadi, dan hal lain yang relevan.</div>
                            </div>
                            <div class="mb-3">
                                <label for="foto" class="form-label">Foto Perangkat (Opsional)</label>
                                <input type="file" class="form-control" id="foto" name="foto">
                                <div class="form-text">Unggah gambar yang menunjukkan masalah perangkat (format: JPG, PNG. Max: 2MB)</div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Tingkat Urgensi</label>
                                <div class="d-flex">
                                    <div class="form-check me-3">
                                        <input class="form-check-input" type="radio" name="urgensi" id="urgensiRendah" value="rendah">
                                        <label class="form-check-label" for="urgensiRendah">Rendah</label>
                                    </div>
                                    <div class="form-check me-3">
                                        <input class="form-check-input" type="radio" name="urgensi" id="urgensiSedang" value="sedang" checked>
                                        <label class="form-check-label" for="urgensiSedang">Sedang</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="urgensi" id="urgensiTinggi" value="tinggi">
                ...
                <div id="riwayatKonsultasi" class="card shadow-sm mb-4">
                    <div class="card-header bg-white">
                        <div class="d-flex align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock-history text-primary me-2" viewBox="0 0 16 16">
                                <path d="M8.515 1.019A7 7 0 0 0 8 1V0a8 8 0 0 1 .589.022l-.074.997zm2.004.45a7.003 7.003 0 0 0-.985-.299l.219-.976c.383.086.76.2 1.126.342l-.36.933zm1.37.71a7.01 7.01 0 0 0-.439-.27l.493-.87a8.025 8.025 0 0 1 .979.654l-.615.789a6.996 6.996 0 0 0-.418-.302zm1.834 1.79a6.99 6.99 0 0 0-.653-.796l.724-.69c.27.285.52.59.747.91l-.818.576zm.744 1.352a7.08 7.08 0 0 0-.214-.468l.893-.45a7.976 7.976 0 0 1 .45 1.088l-.95.313a7.023 7.023 0 0 0-.179-.483zm.53 2.507a6.991 6.991 0 0 0-.1-1.025l.985-.17c.067.386.106.778.116 1.17l-1 .025zm-.131 1.538c.033-.17.06-.339.081-.51l.993.123a7.957 7.957 0 0 1-.23 1.155l-.964-.267c.046-.165.086-.332.12-.501zm-.952 2.379c.184-.29.346-.594.486-.908l.914.405c-.16.36-.345.706-.555 1.038l-.845-.535zm-.964 1.205c.122-.122.239-.248.35-.378l.758.653a8.073 8.073 0 0 1-.401.432l-.707-.707z"/>
                                <path d="M8 1a7 7 0 1 0 4.95 11.95l.707.707A8.001 8.001 0 1 1 8 0v1z"/>
                                <path d="M7.5 3a.5.5 0 0 1 .5.5v5.21l3.248 1.856a.5.5 0 0 1-.496.868l-3.5-2A.5.5 0 0 1 7 9V3.5a.5.5 0 0 1 .5-.5z"/>
                            </svg>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-outline-primary view-konsultasi" data-bs-toggle="modal" data-bs-target="#detailModal" 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 foto-container" style="display: none;">
                    <strong>Foto:</strong>
                    <div class="mt-2">
                        <img id="modal-foto" src="" alt="Foto Perangkat" class="img-fluid rounded" style="max-height: 300px;">
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (detailModal) {
        detailModal.addEventListener('show.bs.modal', function(event) {
            ...
            document.getElementById('modal-kategori').textContent = kategori.charAt(0).toUpperCase() + kategori.slice(1);
            ...
            if (fotoBase64) {
                ...
                modalFoto.onerror = function() {
                    ...
                    fotoContainer.innerHTML = '<div class="alert alert-warning">Gambar tidak dapat ditampilkan. File mungkin tidak ditemukan.</div>';
                };
            } else {
